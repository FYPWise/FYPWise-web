...
$project->get("/FYPWise-web/milestonesubmission","Pages/project-management-mgt/milestone-submission.php");
$project->post("/FYPWise-web/milestonesubmission", "Pages/project-management-mgt/milestone-submission.php");
$project->get("/FYPWise-web/projectplanapproval","Pages/project-management-mgt/project-plan-approval.php");
$project->post( "/FYPWise-web/projectplanapproval","Pages/project-management-mgt/project-plan-approval.php");
