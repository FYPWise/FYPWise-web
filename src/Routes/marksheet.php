...
$marksheetRoutes->post("/FYPWise-web/criteriapage","Pages/marksheet-mgt/criteriascore.php"); 
...
$marksheetRoutes->get("/FYPWise-web/marksheetdetails/([0-9]+)", function($marksheetID) {
    $_GET['marksheetID'] = $marksheetID; 
