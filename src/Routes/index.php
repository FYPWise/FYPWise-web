...
$router->post("/FYPWise-web/register","Pages/user-management/student-registration-page.php");
$router->get("/FYPWise-web/dashboard","Pages/user-management/user-dashboard-page.php");
$router->post("/FYPWise-web/dashboard","Pages/user-management/user-dashboard-page.php");
$router->get("/FYPWise-web/profilemanagement","Pages/user-management/profile-mgt-page.php");
$router->post("/FYPWise-web/profilemanagement","Pages/user-management/profile-mgt-page.php");

// Admin
$router->get("/FYPWise-web/new-user", "Pages/administration/new-user-page.php");
$router->post("/FYPWise-web/new-user", "Pages/administration/new-user-page.php");
