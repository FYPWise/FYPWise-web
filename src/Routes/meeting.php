...
$meetingRoutes->get("/FYPWise-web/view-meeting-log-details/([0-9]+)", function($meetingLogID) {
    echo "Meeting Log ID received: $meetingLogID";  // Debugging: To check if meetingLogID is captured correctly
